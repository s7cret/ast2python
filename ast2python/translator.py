    ...
    def translate_program(
        ...
        *,
        ...
        generated_artifact = build_generated_artifact_v2(
            source=source or "",
            ast_payload=program.raw,
            ast_artifact=ast_artifact,
            emitted_module=emitted_module,
            source_map=source_map,
            frontend_artifact=frontend_artifact,
            support_profile=support_profile,
            producer_commits=producer_commits,
            semantic_profile=semantic_profile,
            entrypoint_module=result_module_name,
            entrypoint_class=metadata["class_name"],
...
__all__ = ["Translator", "translate_ast"]
