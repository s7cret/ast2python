...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("real_world_smoke/13_input_source_strategy_state.ast.json", {"input.source", "input.int", "ta.ema", "strategy.entry"}),
    ],
)
def test_v0_7_real_pine2ast_fixtures_translate_and_compile(relative: str, expected: set[str]) -> None:
    ...
    assert result.metadata["generator_milestone"] == "v0.8.0"


def test_v0_7_unsupported_request_financial_is_diagnostic_not_placeholder_crash() -> None:
    result = translate_ast(load_ast(PINE2AST / "real_world_smoke/14_na_request_financial.ast.json"), module_name="request_financial")
...
def test_v0_7_alert_recorder_generation() -> None:
    program = {
        ...
        "language": "pine",
        "version": 6,
        "declaration": {"kind": "DeclarationStatement", "script_type": "indicator", "call": {"kind": "CallExpr", "callee": {"kind": "Identifier", "name": "indicator"}, "arguments": [{"kind": "Argument", "name": None, "value": {"kind": "Literal", "literal_type": "string", "value": "alerts"}}]}},
        "items": [
            {"kind": "ExpressionStatement", "span": {"start_line": 3, "start_col": 1}, "expression": {"kind": "CallExpr", "callee": {"kind": "Identifier", "name": "alert"}, "arguments": [{"kind": "Argument", "name": None, "value": {"kind": "Literal", "literal_type": "string", "value": "ping"}}]}},
            {"kind": "ExpressionStatement", "span": {"start_line": 4, "start_col": 1}, "expression": {"kind": "CallExpr", "callee": {"kind": "Identifier", "name": "alertcondition"}, "arguments": [{"kind": "Argument", "name": None, "value": {"kind": "Literal", "literal_type": "bool", "value": True}}, {"kind": "Argument", "name": "title", "value": {"kind": "Literal", "literal_type": "string", "value": "ok"}}]}},
        ],
    }
