            ...
            "arguments": [
                {
                    "kind": "Argument",
                    "name": None,
                    "value": {"kind": "Literal", "literal_type": "string", "value": "v04"},
                }
            ],
        },
    }
    ...
    items = [
        {
            ...
            "name": "Pivot",
            "fields": [
                {"kind": "Field", "name": "price", "type": "float"},
                {"kind": "Field", "name": "index", "type": "int"},
            ],
        },
        {
            ...
            "name": "Direction",
            "values": [
                {"kind": "EnumValue", "name": "long"},
                {"kind": "EnumValue", "name": "short"},
            ],
        },
        {
            ...
            "name": "addOne",
            "params": [
                {"kind": "Parameter", "name": "x", "type_ref": {"kind": "TypeRef", "name": "int"}}
            ],
            "body": {
                "kind": "Block",
                "statements": [
            ...
            "params": [
                {
                    "kind": "Parameter",
                    "name": "this",
                    "type_ref": {"kind": "TypeRef", "name": "Pivot"},
                },
                {
                    "kind": "Parameter",
                    "name": "n",
                    "type_ref": {"kind": "TypeRef", "name": "float"},
                },
            ],
            "body": {
                "kind": "Block",
        ...
        {"kind": "VarDeclaration", "name": "x", "initializer": lit(0)},
        {
            ...
            "initializer": {
                "kind": "CallExpr",
                "callee": ident("Pivot"),
                "arguments": [arg(lit(1.5, "float"), "price"), arg(lit(7), "index")],
            },
        },
        {
            "kind": "VarDeclaration",
            ...
            "initializer": {
                "kind": "MemberAccessExpr",
                "member": "price",
                "object": {"kind": "HistoryRefExpr", "base": ident("p"), "offset": lit(10)},
            },
        },
        {
            "kind": "VarDeclaration",
            ...
            "initializer": {
                "kind": "CallExpr",
                "callee": {"kind": "MemberAccessExpr", "object": ident("p"), "member": "pricePlus"},
                "arguments": [arg(lit(2.0, "float"))],
            },
        },
        {
            "kind": "VarDeclaration",
            ...
            "initializer": {
                ...
                "subject": ident("x"),
                "cases": [
                    {"kind": "SwitchCase", "value": lit(0), "expression": lit(10)},
                    {"kind": "SwitchCase", "default": True, "expression": lit(20)},
                ],
            },
        },
        {
        ...
        {
            "kind": "WhileStructure",
            "condition": {"kind": "BinaryExpr", "op": "<", "left": ident("x"), "right": lit(5)},
            "body": {
                "kind": "Block",
                "statements": [
                    {"kind": "Reassignment", "target": ident("x"), "op": "+=", "value": lit(1)},
                    {"kind": "BreakStatement"},
                ],
            },
        },
...
def test_v0_4_visual_recorder_storage_methods_and_misuse_diagnostic():
    visual_new = {
        "kind": "CallExpr",
        "callee": {"kind": "MemberAccessExpr", "object": ident("line"), "member": "new"},
        "arguments": [arg(lit(0)), arg(ident("close")), arg(lit(1)), arg(ident("close"))],
    }
    ok = program(
        [
            {
            ...
            },
            {
                ...
                "expression": {
                    ...
                    "arguments": [arg(ident("ln")), arg(ident("bar_index")), arg(ident("close"))],
                },
            },
            {
                "kind": "ExpressionStatement",
                "expression": {
                    "kind": "CallExpr",
                    "callee": {"kind": "Identifier", "name": "plotshape"},
                    "arguments": [
                        arg(
                            {
                                "kind": "BinaryExpr",
